<?php
/**
 * Standalone install + heartbeat reporter for Panth_BannerSlider.
 *
...
namespace Panth\BannerSlider\Service;
...
class InstallReporter
{
    ...
    public const MAGENTO_MODULE = 'Panth_BannerSlider';

    /** Composer package name reported to the receiver. */
    public const COMPOSER_PACKAGE = 'mage2kishan/module-banner-slider';
